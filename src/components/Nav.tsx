...
export default function Nav() {
    ...
    return (
        <div className="story-wrap">
            <div className="fixed lg:top-0 lg:left-0 bottom-0 w-full bg-white-500 lg:h-full lg:w-[215px] flex">
                <ul className="bg-white text-center w-full rounded-full lg:rounded-md h-[95%] justify-items-center m-2 lg:m-5 shadow-custom p-2 lg:p-5 grid grid-cols-5 lg:block">
                    <li 
                    ...
                    {navItems.map((item) => {
                        const isActive = active === item.label;
                            return (
                                ...
                                <li key={item.label}
                                    className=" items-center m-1 p-2 lg:p-3 cursor-pointer rounded lg:w-[160px]"
                                >
                                    <Link 
                                        ...
                                        <div className="hidden lg:block">
                                            <span className={isActive ? `${styles.textActive} text-xs lg:text-[16px] font-normal` : 'text-black text-xs lg:text-[16px] font-normal'}>{item.label}</span>
                                        </div>
                                    </Link>
                                </li>
                            );
